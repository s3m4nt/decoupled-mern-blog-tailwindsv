    ...
    <>
        <nav className="bg-yellow-300 flex justify-between item-center h-16 bg-white text-black relative shadow-md font-mono pt-10 pb-14" role="navigation">
            ...
            <div className="pr-8 md:block hidden">
                <Link className="p-4 hover:underline" to="/">BLOG.</Link> <span className="text-black">|</span>
                <Link className="p-4 hover:underline" to="/About">About</Link> <span className="text-black">|</span>
